...
public class BillAdapter extends RecyclerView.Adapter<BillAdapter.BillHolder> {
    ...
    public void onBindViewHolder(BillHolder holder, int position) {
        if(mCursor.moveToPosition(position)){
            ...
            @SuppressLint("Range") long id = mCursor.getLong(mCursor.getColumnIndex(GSTBillingEntry._ID));
            @SuppressLint("Range") String customerName = mCursor.getString(mCursor.getColumnIndex(GSTBillingEntry.PRIMARY_COLUMN_NAME));
            @SuppressLint("Range") String phoneNumber = mCursor.getString(mCursor.getColumnIndex(GSTBillingEntry.PRIMARY_COLUMN_PHONE_NUMBER));
            @SuppressLint("Range") String date = mCursor.getString(mCursor.getColumnIndex(GSTBillingEntry.PRIMARY_COLUMN_DATE));
